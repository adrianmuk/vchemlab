...
class Periodictablepage extends Component {
  constructor() {
    super();
    this.state = {
      elementsList: [],
    ...
    return (
      ...
      <div id='content'>
        ...
        <div id='period-table-container'>
          {
            this.state.elementsList.map(item => {
              ...
              return (
                ...
                >  
                  <p className='panelnum'>{item.number}</p>
                  <h3 className='panelsymb'>{item.symbol}</h3>
                </a>
        ...
        <div className='footer_cls'>
          <span>Designed and built by Alozious & Adrian</span>
        </div>
